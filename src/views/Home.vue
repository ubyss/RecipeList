<template>
  <div class="home">
    ...
    <button @click='togglePopup'>Adicione uma nova receita</button>
    <div class="recipes">
      ...
      <div class="popup-content">
        ...
        <form @submit.prevent='addNewRecipe'>
          ...
          <div class="group">
            ...
            <button type="button" @click="addNewIngredient">Adicionar ingrediente</button>
          </div>
          ...
          <div class="group">
            <label>Metodo de preparo</label>
              ...
              <button type="button" @click="addNewStep">Adicionar passo-a-passo</button>
          </div>
